...
#ifndef __SIMULATOR_SELFISHVALIDATOR_H_
#define __SIMULATOR_SELFISHVALIDATOR_H_
...
namespace framework {
class SelfishValidator : public PlausibilityValidation
{
protected:
    ...
    virtual TransactionInfo validateTransaction(
            ...
            const TransactionPtr& transaction) override;
public:
