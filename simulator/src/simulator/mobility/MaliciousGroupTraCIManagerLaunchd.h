...
#ifndef __SIMULATOR_MALICIOUSGROUPTRACIMANAGERLAUNCHD_H_
#define __SIMULATOR_MALICIOUSGROUPTRACIMANAGERLAUNCHD_H_
...
namespace framework {
class MaliciousGroupTraCIManagerLaunchd : public DoubleTypeTraCIManagerLaunchd
{
protected:
    int onRoad;
